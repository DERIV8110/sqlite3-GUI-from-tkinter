...
#users = [("Patient",1),("Medical Staff",2),("Administrator",3)]
                                                                   #reads variable in the list
#user.set("Patient")                                                                   #preset is patient
#
#for text, part in users:
#	ttk.Radiobutton(root, text=text, variable=user, value=part).grid(column=1,row=3)   #part is value in the list
#
def clicked(value):
       global res
       res=value
