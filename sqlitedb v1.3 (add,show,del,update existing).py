...
def submit():
       ...
       c.execute("INSERT INTO intro VALUES(:name,:address,:phone,:index)",
                 {"name":name_edit.get(),
...
shw_btn= Button(root,text="show items in database",command=shw).grid(row=5,columnspan=2)
